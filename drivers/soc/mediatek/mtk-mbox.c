 ...
 */
static void mtk_memcpy_to_tinysys(void __iomem *dest, const void *src, uint32_t size)
{
	int i;
	u32 __iomem *t = dest;
	const u32 *s = src;
 ...
 * @param size: memory size
 */
static void mtk_memcpy_from_tinysys(void *dest, const void __iomem *src, uint32_t size)
{
	int i;
	u32 *t = dest;
